    ...
    <div className="slide aspect-video w-full relative flex flex-col">
      <div className="flex flex-1 min-h-0">
        <div className="w-[46%] flex flex-col justify-center p-[5%_4%_5%_6%]">
          ...
          <p className="font-sans text-white leading-relaxed mb-3" style={{ fontSize: "clamp(11px, 1.1vw, 15px)", ...f(on, 100) }}>
          ...
          <p className="font-sans text-white leading-relaxed" style={{ fontSize: "clamp(11px, 1.1vw, 15px)", ...f(on, 180) }}>
        ...
        <div className="flex-1 relative" style={f(on, 100)}>
          <div className="absolute" style={{ top: "18%", left: "42%" }}>
            <div className="font-mono text-white text-sm font-medium tracking-widest uppercase border border-white/40 px-3 py-1.5 bg-black/60 mb-1.5 w-fit">
              MEXICO CITY
            </div>
            <div className="font-mono text-[#FFEC40] text-[8px] font-medium tracking-widest uppercase border border-[#FFEC40] px-2 py-0.5 w-fit">
              COMING SOON
            </div>
          </div>
          <div className="absolute" style={{ bottom: "32%", right: "20%" }}>
            <div className="font-mono text-white text-sm font-medium tracking-widest uppercase border border-white/40 px-3 py-1.5 bg-black/60 w-fit">
              SANTIAGO
            </div>
          </div>
        </div>
