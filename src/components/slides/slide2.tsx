...
export function Slide2({ active }: P) {
  ...
  return (
    <div className="slide aspect-video w-full relative flex justify-center items-center md:p-[6%]">
      <h1 className="font-sans font-medium text-white leading-[1.3]" style={{ fontSize: "58px" }}>
