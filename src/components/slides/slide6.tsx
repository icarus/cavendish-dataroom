...
export function Slide6({ active }: P) {
  ...
  const items = [
    { Icon: Code2, title: "TECHNICAL FOUNDER THESIS", desc: "Technical founders move faster and avoid high expense." },
    { Icon: Zap, title: "ELITE DEVELOPER COMMUNITY", desc: "12 years building a developer community that funds top tech startups." },
    { Icon: Globe, title: "COMMUNITY-DRIVEN MODEL", desc: "Trust drives deal flow, community is our moat." },
