  ...
  return (
    <div className="slide aspect-video w-full relative flex">
      <div className="flex-1 flex flex-col justify-between">
        <p className="font-sans font-medium text-white leading-relaxed p-[6%_5%] w-4/5" style={{ fontSize: "23px", ...f(on, 0) }}>
          In just five years,{" "}
        ...
        <div className="bg-[#1c1c1c] flex flex-col justify-end p-[5%]" style={{ ...grow(on, 200), height: "45%" }}>
          <div className="font-mono uppercase font-medium text-white leading-none" style={{ fontSize: "77px" }}>9.161</div>
      ...
      <div className="w-[50%] bg-[#FFEC40] flex flex-col justify-between p-[3%_3%]" style={f(on, 100)}>
        <div>
          <div className="font-mono uppercase font-medium text-black leading-none" style={{ fontSize: "102px" }}>20.000+</div>
