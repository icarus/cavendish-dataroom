...
export function SectionTerminos() {
  ...
  return (
    <section id="terminos" className="py-16">
      ...
      <p className="font-sans font-medium text-black/60 text-sm leading-relaxed mb-4">
        Al firmar el Subscription Agreement se paga el <span className="bg-[#474402] text-[#FFEC40] px-1  text-black">30%</span> del capital comprometido. El resto sigue este calendario tentativo:
      </p>
      <Callout>
