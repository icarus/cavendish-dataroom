...
export function SectionKalio() {
  return (
    <section id="kalio" className="py-16 border-b border-black/10">
      <Badge variant="solid" className="mb-4">07</Badge>
      ...
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          Kalio es el <span className="bg-[#474402] text-[#FFEC40] px-1">centro de la operación de Platanus</span>. Somos un VC con base tecnológica y nuestro equipo puede ser tan pequeño porque delegamos gran parte de nuestros procesos al software que construimos.
        </p>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
      ...
      <div className="border border-black/10 p-5 bg-black/5 mb-4">
        ...
        <div className="space-y-3">
          ...
          <Callout>
            <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
              Como parte de Kalio tenemos a <span className="bg-[#474402] text-[#FFEC40] px-1">Frank</span>, un bot conectado a Slack que nos permite realizar seguimiento detallado y nos notifica los cambios de cada aplicación. Evita que olvidemos postulaciones y mantiene al equipo al tanto de las etapas.
            </p>
          </Callout>
        </div>
      </div>
