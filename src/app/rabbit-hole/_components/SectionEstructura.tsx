...
export function SectionEstructura() {
  return (
    <section id="estructura" className="py-16 border-b border-white/10">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5mb-4">08</span>
      ...
      <div className="border border-white/10 p-5 bg-white/5 mb-4">
        <h3 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3">
          ¿Por qué Canadá?
        </h3>
      ...
      <div className="border border-white/10 p-5 bg-white/5 mb-4">
        ...
        <div className="space-y-3">
          ...
          {/* Motivos principales */}
          <div className="mt-4">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-2">
          ...
          <div className="mt-4">
            ...
            <div className="space-y-3">
              <div className="border border-white/10 p-4 bg-white/5">
                <p className="font-sans font-medium text-white/70 text-sm mb-1">Estructura de 2 capas</p>
                <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
            ...
            <div className="space-y-2 mt-3">
              ...
              <ol className="list-decimal list-outside pl-5 space-y-2">
                <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Comprar las acciones de la C-Corp.</li>
                <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Comprarle a la C-Corp cada una de las sociedades operativas de Latam.</li>
              </ol>
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
              ...
              <ol className="list-decimal list-outside pl-5 space-y-2">
                <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Comprar las acciones de la holding en Caimán.</li>
                <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Comprarle a la holding de Caimán la LLC (e indirectamente todas las sociedades operativas).</li>
                <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Comprarle a la LLC cada sociedad operativa.</li>
              </ol>
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
