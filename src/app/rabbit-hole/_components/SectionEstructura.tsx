...
export function SectionEstructura() {
  return (
    <section id="estructura" className="py-16 border-b border-[#E5E7EB]">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5 rounded mb-4">08</span>
      ...
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          El fondo se ha estructurado como una <span className="bg-[#FFEC40] px-1 rounded">Limited Partnership Canadiense</span>.
        </p>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      <div className="border border-[#E5E7EB] rounded-lg p-5 bg-white shadow-sm mb-4">
        <h3 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3">
          ¿Por qué Canadá?
        </h3>
      ...
      <div className="border border-[#E5E7EB] rounded-lg p-5 bg-white shadow-sm mb-4">
        ...
        <div className="space-y-3">
          ...
          {/* Motivos principales */}
          <div className="mt-4">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-2">
          ...
          <div className="mt-4">
            ...
            <div className="space-y-3">
              <div className="border border-[#E5E7EB] rounded-lg p-4 bg-[#F9FAFB]">
                <p className="font-sans font-medium text-[#111111] text-base mb-1">Estructura de 2 capas</p>
                <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
              ...
              <div className="border border-[#E5E7EB] rounded-lg p-4 bg-[#F9FAFB]">
                <div className="flex items-center gap-2 mb-1">
                  <p className="font-sans font-medium text-[#111111] text-base">Estructura de 3 capas</p>
                  <span className="bg-[#FFEC40] text-black font-mono font-medium text-xs px-1.5 py-0.5 rounded">recomendada</span>
                </div>
                <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
            ...
            <div className="space-y-2 mt-3">
              ...
              <ol className="list-decimal list-outside pl-5 space-y-2">
                <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Comprar las acciones de la C-Corp.</li>
                <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Comprarle a la C-Corp cada una de las sociedades operativas de Latam.</li>
              </ol>
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
              ...
              <ol className="list-decimal list-outside pl-5 space-y-2">
                <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Comprar las acciones de la holding en Caimán.</li>
                <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Comprarle a la holding de Caimán la LLC (e indirectamente todas las sociedades operativas).</li>
                <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Comprarle a la LLC cada sociedad operativa.</li>
              </ol>
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      <Callout>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Este proceso de constituir sociedades sobre las sociedades operativas o sobre la LLC es lo que se conoce como un <span className="bg-[#FFEC40] px-1 rounded">"Flip"</span>.
        </p>
      </Callout>
    </section>
  );
