...
export function SectionDiagnostico() {
  return (
    <section id="diagnostico" className="py-16 border-b border-white/10">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5mb-4">01</span>
      ...
      <div className="space-y-4 mb-10">
        ...
        <div>
          <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-3">Hace cinco años partimos Platanus para:</p>
          <ol className="list-decimal list-outside pl-5 space-y-2">
            <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Apoyar a los fundadores en las etapas más iniciales de una startup.</li>
            <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Incentivar la creación de más startups tech en Latam lideradas por personas excepcionales y con capacidad técnica.</li>
            <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">Lograr retornos atractivos y de manera consistente con mentalidad de <span className="italic">adventure</span> capital.</li>
          </ol>
        </div>
        <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
      ...
      {/* Problem 1 */}
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3">Levantar capital inicial en Latam es difícil</h4>
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
      ...
      {/* Problem 2 */}
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3">Cómo pasar de 0 a 1</h4>
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
      ...
      {/* Problem 3 */}
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3">Falta de una comunidad de founders increíbles que ayuden a sortear problemas</h4>
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
      ...
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-6 mt-2">
      ...
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-4">
        A estas startups las sumamos a un <span className="font-sans font-medium text-white">programa de aceleración</span>.
      </p>
      ...
      <Callout>
        ...
        <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-2">Dos cosas nos distinguen de otras aceleradoras:</p>
        <ul className="list-disc list-outside pl-5 space-y-2">
          <li className="font-sans font-medium text-white/70 text-sm leading-relaxed">
      ...
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-4 mt-6">
      ...
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {["Platanus Hack", "Platanus Forum", "Demo Devs", "Demo Days", "Build Nights", "AI Native", "Kernel Club", "Comidas entre fundadores"].map((event) => (
          <div key={event} className="border border-white/10 px-4 py-2.5 bg-white/5">
            <span className="font-mono font-medium text-white/70 text-sm">{event}</span>
          </div>
        ))}
      </div>
    </section>
