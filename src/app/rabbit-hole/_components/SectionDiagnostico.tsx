...
export function SectionDiagnostico() {
  return (
    <section id="diagnostico" className="py-16 border-b border-[#E5E7EB]">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5 rounded mb-4">01</span>
      ...
      <div className="space-y-4 mb-10">
        ...
        <div>
          <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-3">Hace cinco años partimos Platanus para:</p>
          <ol className="list-decimal list-outside pl-5 space-y-2">
            <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Apoyar a los fundadores en las etapas más iniciales de una startup.</li>
            <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Incentivar la creación de más startups tech en Latam lideradas por personas excepcionales y con capacidad técnica.</li>
            <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Lograr retornos atractivos y de manera consistente con mentalidad de <span className="italic">adventure</span> capital.</li>
          </ol>
        </div>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      {/* Problem 1 */}
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3">Levantar capital inicial en Latam es difícil</h4>
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      {/* Problem 2 */}
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3">Cómo pasar de 0 a 1</h4>
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      {/* Problem 3 */}
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3">Falta de una comunidad de founders increíbles que ayuden a sortear problemas</h4>
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      <Callout>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-3">
          Invertimos <span className="bg-[#FFEC40] px-1 rounded">US$200,000</span> en las primeras etapas de equipos excepcionales, priorizando los intereses de los fundadores y el éxito de la startup.
        </p>
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-6 mt-2">
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4">
        A estas startups las sumamos a un <span className="font-sans font-medium text-[#111111]">programa de aceleración</span>.
      </p>
      ...
      <Callout>
        ...
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-2">Dos cosas nos distinguen de otras aceleradoras:</p>
        <ul className="list-disc list-outside pl-5 space-y-2">
          <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">
            <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">"Quod natura non dat, Platanus non praestat"</span>. Este no es un programa educativo. Lo que busca es que los fundadores se potencien entre ellos y construyan sus negocios recibiendo consejos y accountability.
          </li>
          <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4 mt-6">
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-8">
        Hoy contamos con <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">+120 startups</span> en el portafolio, <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">+350 fundadores</span> repartidos en <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">+10 países</span> y una amplia red de mentores.
      </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {["Platanus Hack", "Platanus Forum", "Demo Devs", "Demo Days", "Build Nights", "AI Native", "Kernel Club", "Comidas entre fundadores"].map((event) => (
          <div key={event} className="border border-[#E5E7EB] rounded-lg px-4 py-2.5 bg-white shadow-sm">
            <span className="font-mono font-medium text-[#111111] text-sm">{event}</span>
          </div>
        ))}
      </div>
    </section>
