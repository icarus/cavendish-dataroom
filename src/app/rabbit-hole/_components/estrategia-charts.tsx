          ...
          {bars.map((bar) => {
            ...
            return (
              <div key={bar.label} className="flex flex-col items-center justify-end flex-1 h-full">
                <span className="font-mono uppercase font-medium text-black mb-1 leading-tight text-center" style={{ fontSize: "11px" }}>
                  {bar.display}
                </span>
        ...
        <div className="flex gap-3 mt-2">
          {bars.map((bar) => (
            <div key={bar.label} className="flex-1 text-center">
              <span className="font-mono uppercase font-medium text-black leading-tight text-center block" style={{ fontSize: "11px" }}>
                {bar.label}
              </span>
            </div>
          ))}
