...
export function SectionPortafolio() {
  return (
    <section id="portafolio" className="py-16 border-b border-[#E5E7EB]">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5 rounded mb-4">05</span>
      ...
      <div className="space-y-4 mb-10">
        ...
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">Para esto, hay que fijar algunos supuestos:</p>
        <ul className="list-disc list-outside pl-5 space-y-2">
          {[
            ...
            <li key={item} className="font-sans font-medium text-[#111111] text-base leading-relaxed">{item}</li>
          ))}
        </ul>
      </div>

      {/* Monto a invertir */}
      <h3 className="font-sans font-medium text-[#6B7280] mb-4" style={{ fontSize: "clamp(18px, 2vw, 28px)" }}>
        Monto a invertir
      </h3>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4">
        ...
        <table className="w-full border-collapse">
          <tbody>
            {[
              ...
              <tr key={row.label} className={`border-b ${row.bold ? "border-[#E5E7EB] bg-[#FFEC40]" : "border-[#F3F4F6]"}`}>
                <td className={`font-sans font-medium text-base py-2.5 pr-8 ${row.bold ? "text-[#111111]" : row.sub ? "text-[#111111] pl-4" : "text-[#111111]"}`}>
                  {row.label}
                </td>
                <td className={`font-mono font-medium text-base py-2.5 text-right ${row.bold ? "text-[#111111]" : "text-[#111111]"}`}>
                  {row.value}
                </td>
              </tr>
            ))}
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-6">
      ...
      <div className="space-y-4 mb-6">
        {[
          ...
          <div key={type.name} className="border border-[#E5E7EB] rounded-lg p-5 bg-white shadow-sm">
            <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-2">{type.name}</h4>
            <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-3">{type.desc}</p>
            <ul className="list-disc list-outside pl-5 space-y-2">
              {type.details.map((d) => (
                <li key={d} className="font-sans font-medium text-[#111111] text-base leading-relaxed">{d}</li>
              ))}
            </ul>
          </div>
        ))}
      ...
      {/* Tamaño de ticket */}
      <h3 className="font-sans font-medium text-[#6B7280] mb-4 mt-10" style={{ fontSize: "clamp(18px, 2vw, 28px)" }}>
        Tamaño de ticket y valorizaciones de entrada
      </h3>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4">Realizaremos tres tipos de inversiones:</p>
      <div className="space-y-3 mb-10">
        {[
          ...
          <div key={item.title} className="flex gap-4 py-3 border-b border-[#E5E7EB] last:border-0">
            <span className="text-[#FFEC40] bg-[#111111] rounded-full w-5 h-5 flex items-center justify-center shrink-0 mt-0.5 text-xs">→</span>
            <div>
              <span className="font-sans font-medium text-[#111111] text-base">{item.title}: </span>
              <span className="font-sans font-medium text-[#111111] text-base leading-relaxed">{item.body}</span>
            </div>
          </div>
        ))}
      </div>
            ...
            <tbody>
              {[
                ...
                <tr key={row.label} className="border-b border-[#F3F4F6]">
                  <td className="font-sans font-medium text-[#111111] text-base py-2.5 pr-4">{row.label}</td>
                  <td className="font-mono font-medium text-[#111111] text-base py-2.5 text-right">{row.value}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-10">
        Nuestra estrategia es vender nuestra participación en las rondas de financiamiento de nuestras startups. Para los cálculos, utilizamos un rango de valorizaciones al momento del exit de entre <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">$250M a $500M</span>. Cualquier exit con un valor superior mejorará las métricas del fondo sustancialmente.
      </p>

      {/* Portafolio esperado */}
      <h2 className="font-sans font-medium text-[#111111] mb-8 mt-4" style={{ fontSize: "clamp(22px, 2.5vw, 36px)", lineHeight: 1.2 }}>
      ...
      <div className="space-y-4 mb-6">
        ...
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Destinaremos <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">$6,400,000</span> para estas inversiones, <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">32 nuevas startups</span> bajo los términos fijos de $200.000 por un 7% de participación.
        </p>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Estas inversiones se distribuyen en generaciones del programa, una generación cada semestre.
        </p>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">Este sería el avance del portafolio según las tasas de éxito:</p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <div key={item.label} className="border border-[#E5E7EB] rounded-lg p-4 bg-white shadow-sm text-center">
              <p className="font-mono font-medium text-[#111111] text-2xl mb-1">{item.value}</p>
              <p className="font-sans font-medium text-[#111111] text-sm leading-snug">{item.label}</p>
            </div>
          ))}
        </div>
      </div>
          ...
          <thead>
            <tr className="border-b border-[#E5E7EB]">
              {["MOIC", "% startups", "# startups", "Val. exit", "Exit value", "Total"].map((h) => (
                <th key={h} className="text-left font-mono font-medium text-[#111111] text-xs uppercase tracking-wider pb-3 pr-3">{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {[
              ...
              <tr key={row.moic} className={`border-b ${row.highlight ? "bg-[#FFEC40]" : "border-[#F3F4F6]"}`}>
                <td className="font-mono font-medium text-[#111111] text-sm py-2.5 pr-3">{row.moic}</td>
                <td className="font-sans font-medium text-[#111111] text-sm py-2.5 pr-3">{row.pct}</td>
                <td className="font-mono font-medium text-[#111111] text-sm py-2.5 pr-3">{row.n}</td>
                <td className="font-mono font-medium text-[#111111] text-sm py-2.5 pr-3">{row.val}</td>
                <td className="font-mono font-medium text-[#111111] text-sm py-2.5 pr-3">{row.exit}</td>
                <td className="font-mono font-medium text-[#111111] text-sm py-2.5">{row.total}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="space-y-4 mt-6 mb-10">
        <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider">Generaciones a la fecha</h4>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          A la fecha el fondo ya ha realizado 4 inversiones a través de dos generaciones:
        </p>
        <ul className="list-disc list-outside pl-5 space-y-2">
          <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Generación 25: 4 startups.</li>
        </ul>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Estamos en proceso de selección de la generación 26-I, donde ya hemos seleccionado 4 startups.
        </p>

        <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mt-4">Proyección de startups por generación</h4>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">Para llegar a las 32 startups, invertiremos en 6 generaciones:</p>
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
          {[
            ...
            <div key={g.gen} className="border border-[#E5E7EB] rounded-lg p-3 bg-white shadow-sm text-center">
              <p className="font-mono font-medium text-[#111111] text-xl mb-0.5">{g.n}</p>
              <p className="font-mono font-medium text-[#111111] text-xs uppercase tracking-wider">Gen {g.gen}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-4 mb-6">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Destinaremos <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">$1,800,000</span> para estas inversiones, 9 nuevas startups si pensamos en tickets de $200k.
        </p>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">Las inversiones oportunísticas están destinadas a:</p>
        <ul className="list-disc list-outside pl-5 space-y-2">
          <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">High Pre Seed que estén levantando a una valorización que haga difícil aceptar el ticket estándar (por ejemplo están levantando una ronda de $750k a una valorización de $5M y ya llevan $300k levantados). Como son inversiones en teoría con mayor tasa de éxito, sacrificamos un porcentaje de participación para bajar el riesgo al portafolio.</li>
          <li className="font-sans font-medium text-[#111111] text-base leading-relaxed">Fundadores Low Pre Seed que nos gustaría invertirles menos que los $200k del deal fijo del programa de aceleración.</li>
        </ul>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          A la fecha ya hemos realizado dos: <span className="text-[#111111]">Boom</span> y <span className="text-[#111111]">Utanix</span>.
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
      ...
      <div className="space-y-4 mb-6">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Destinaremos <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">$3,600,000</span> para follow on en startups del portafolio que estén levantando su Serie Seed.
        </p>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-[#E5E7EB]">
              <th className="text-left font-mono font-medium text-[#111111] text-base uppercase tracking-wider pb-3 pr-8">Tipo de ticket</th>
              <th className="text-right font-mono font-medium text-[#111111] text-base uppercase tracking-wider pb-3">Total exit value</th>
            </tr>
          </thead>
          <tbody>
            {[
              ...
              <tr key={row.label} className="border-b border-[#F3F4F6]">
                <td className="font-sans font-medium text-[#111111] text-base py-3 pr-8">{row.label}</td>
                <td className="font-mono font-medium text-[#111111] text-base py-3 text-right">{row.value}</td>
              </tr>
            ))}
            <tr className="bg-[#FFEC40]">
              <td className="font-sans font-medium text-[#111111] text-base py-3 pr-8">Total</td>
              <td className="font-mono font-medium text-[#111111] text-base py-3 text-right">$63,714,286</td>
            </tr>
          </tbody>
        </table>
      </div>
