    ...
    <section id="estructura" className="py-16 border-b border-black/10">
      ...
      <div className="space-y-4 mb-10">
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          El fondo se ha estructurado como una <span className="bg-[#474402] text-[#FFEC40] px-1">Limited Partnership Canadiense</span>.
        </p>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
      ...
      <Callout>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          Este proceso de constituir sociedades sobre las sociedades operativas o sobre la LLC es lo que se conoce como un <span className="bg-[#474402] text-[#FFEC40] px-1">"Flip"</span>.
        </p>
      </Callout>
    </section>
  );
