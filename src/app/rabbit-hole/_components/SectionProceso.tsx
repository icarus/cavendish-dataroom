...
export function SectionProceso() {
  return (
    <section id="proceso" className="py-16 border-b border-[#E5E7EB]">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5 rounded mb-4">06</span>
      ...
      <div className="space-y-4 mb-10">
        ...
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Este proceso es una parte clave de nuestra operación. Desde el 2020 hemos recibido más de <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">9.549 aplicaciones</span> y seleccionado <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">121 startups</span> a través de este proceso.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={s.label} className="border border-[#E5E7EB] rounded-lg p-5 bg-white shadow-sm">
            <p className="font-mono font-medium text-[#111111] mb-1" style={{ fontSize: "clamp(22px, 2.5vw, 36px)" }}>{s.value}</p>
            <p className="font-sans font-medium text-[#111111] text-base">{s.label}</p>
          </div>
        ))}
      </div>
      <div className="space-y-4 mb-10">
        ...
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Desde que una startup es llamada a entrevista, apuntamos a que reciba una respuesta en <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">15 días</span>, manteniendo flexibilidad en caso de necesitar más información para mantener la calidad de la selección.
        </p>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
      ...
      <div className="space-y-0">
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">1</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Formulario</h4>
            <div className="space-y-3">
              ...
              <details className="border border-[#E5E7EB] rounded-lg bg-white">
                <summary className="font-sans font-medium text-[#111111] text-base px-5 py-3 cursor-pointer select-none hover:bg-[#F9FAFB] rounded-lg transition-colors">
                  Ver las preguntas en detalle
                </summary>
                <div className="px-5 pb-5 pt-2 space-y-4 border-t border-[#E5E7EB]">
                  {formQuestions.map((section) => (
                    <div key={section.group}>
                      <p className="font-mono font-medium text-[#111111] text-sm uppercase tracking-wider mb-2">{section.group}</p>
                      <ul className="list-disc list-outside pl-5 space-y-2">
                        {section.items.map((q) => (
                          <li key={q} className="font-sans font-medium text-[#111111] text-base leading-relaxed">{q}</li>
                        ))}
                      </ul>
                    </div>
                  ))}
                  <p className="font-sans font-medium text-[#111111] text-sm leading-relaxed pt-2 border-t border-[#F3F4F6]">
              ...
              <Callout>
                <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
                  Desde Q3 2023, además del formulario les pedimos a las startups que realicen una <span className="bg-[#FFEC40] px-1 rounded">entrevista automatizada</span> como paso previo.
                </p>
              </Callout>
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">2</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Primer filtro</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">3</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Primera entrevista</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
              ...
              <Callout>
                <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
                  Utilizamos un modelo de <span className="bg-[#FFEC40] px-1 rounded">convicción fuerte</span>: al menos uno de los partners debe votar "Sí fuerte" para que continúen en el proceso. Históricamente hemos entrevistado en esta primera etapa a alrededor del <span className="bg-[#FFEC40] px-1 rounded">14%</span> de las startups que aplican.
                </p>
              </Callout>
            </div>
          </div>
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">4</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Segunda entrevista</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
              ...
              <Callout>
                <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
                  Al igual que en la primera entrevista, al menos uno de los partners debe votar "sí fuerte" para pasar a la siguiente etapa. Históricamente hemos entrevistado en esta segunda etapa a alrededor del <span className="bg-[#FFEC40] px-1 rounded">4%</span> de las startups que aplican.
                </p>
              </Callout>
            </div>
          </div>
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">5</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Chequeo de referencias</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">6</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">
              Entrevista en persona <span className="inline-block bg-[#FFEC40] text-[#111111] font-mono font-medium text-xs px-1.5 py-0.5 rounded ml-1">nuevo</span>
            </h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">7</span>
            </div>
            <div className="w-px bg-[#E5E7EB] flex-1 mt-2" />
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Selección</h4>
            <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
        ...
        <div className="flex gap-6 pb-4">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-[#FFEC40] flex items-center justify-center shrink-0">
              <span className="font-mono font-medium text-black text-base">8</span>
            </div>
          </div>
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-[#6B7280] text-base mb-3">Due diligence</h4>
            <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
