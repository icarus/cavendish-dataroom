...
export function SectionProceso() {
  return (
    <section id="proceso" className="py-16 border-b border-white/10">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5mb-4">06</span>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={s.label} className="border border-white/10 p-5 bg-white/5">
            <p className="font-mono font-medium text-white mb-1" style={{ fontSize: "clamp(16px, 2vw, 22px)" }}>{s.value}</p>
            <p className="font-sans font-medium text-white/70 text-sm">{s.label}</p>
          </div>
        ))}
      </div>
      <div className="space-y-4 mb-10">
      ...
      <div className="space-y-0">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Formulario</h4>
            <div className="space-y-3">
              ...
              <details className="border border-white/10 bg-white/5">
                <summary className="font-sans font-medium text-white text-sm px-5 py-3 cursor-pointer select-none hover:bg-white/5 transition-colors">
                  Ver las preguntas en detalle
                </summary>
                <div className="px-5 pb-5 pt-2 space-y-4 border-t border-white/10">
                  {formQuestions.map((section) => (
                    <div key={section.group}>
                      <p className="font-mono font-medium text-white text-sm uppercase tracking-wider mb-2">{section.group}</p>
                      <ul className="list-disc list-outside pl-5 space-y-2">
                        {section.items.map((q) => (
                          <li key={q} className="font-sans font-medium text-white/70 text-sm leading-relaxed">{q}</li>
                        ))}
                      </ul>
                    </div>
                  ))}
                  <p className="font-sans font-medium text-white/70 text-sm leading-relaxed pt-2 border-t border-white/10">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Primer filtro</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Primera entrevista</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Segunda entrevista</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Chequeo de referencias</h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">
              Entrevista en persona <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-xs px-1.5 py-0.5ml-1">nuevo</span>
            </h4>
            <div className="space-y-3">
              <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
        ...
        <div className="flex gap-6 pb-8">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Selección</h4>
            <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
        ...
        <div className="flex gap-6 pb-4">
          ...
          <div className="pb-4 flex-1">
            <h4 className="font-sans font-medium text-white/40 text-sm mb-3">Due diligence</h4>
            <p className="font-sans font-medium text-white/70 text-sm leading-relaxed">
