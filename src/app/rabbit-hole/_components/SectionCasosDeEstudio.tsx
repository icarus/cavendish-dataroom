    ...
    <div className="border border-white/10 bg-white/5 mb-4">
      ...
      <div className="px-6">
        ...
        <CaseSection title="Take-aways del negocio">
          <Body><span className="text-white">22x crecimiento ARR de 2021 a 2025.</span></Body>
          <Body><span className="text-white">Alta eficiencia de capital:</span> lograron $8M ARR con $10.3M en levantamiento (0.78x ratio ARR/Capital Raised).</Body>
          <Body><span className="text-white">Seleccionamos a un equipo que también era interesante para top-tier investors:</span> Monashees hizo su primera apuesta en Chile con Fintoc. Les hicieron follow-on en su Serie A; también invirtieron Y Combinator y Propel Ventures.</Body>
          <Body><span className="text-white">Bajo churn y captación del mercado que tenían otros competidores:</span> startups mexicanas los han ido prefiriendo frente a Belvo.</Body>
        </CaseSection>
        <CaseSection title="Lo que aprendimos">
          <Body><span className="text-white">Estar en el origen te da acceso a las mejores valuaciones:</span> 8 meses después de nuestra inversión, la empresa ya levantó a una valuación 10x más alta. 15 meses después, levantó a ~25× nuestra inversión.</Body>
          <Body><span className="text-white">Comunidad tech esencial para deal-flow:</span> fue gracias a la comunidad de desarrolladores de la fábrica de software que estos fundadores gravitaban en torno a Platanus.</Body>
          <Body><span className="text-white">Comunidad de startups clave para detectar problemas:</span> en nuestro ecosistema había varias fintechs que sufrían el mismo dolor; gracias al acceso que Platanus le daba a Fintoc a esas startups, pudieron detectarlo.</Body>
          <Body><span className="text-white">Comunidad como fuente de clientes:</span> la comunidad de startups es instrumental, porque sirve como primeros clientes a las startups que están naciendo.</Body>
          <Body><span className="text-white">Buen timing de mercado al momento de invertir:</span> estaban bien posicionados para la ola de open banking latinoamericano.</Body>
          <Body><span className="text-white">Capital paciente:</span> el capital pre-semilla en LatAm exige paciencia, pero quienes aguantan esta tensión capturan valuaciones de entrada 10-20x más bajas y retornos finales proporcionalmente más altos cuando el negocio finalmente escala.</Body>
        </CaseSection>
      </div>
    </div>
  );
...
function CaseToku() {
  return (
    <div className="border border-white/10 bg-white/5 mb-4">
      ...
      <div className="px-6">
        <CaseSection title="Resumen ejecutivo">
          <Body>De $18K ARR (agosto 2020) a $16M ARR (Q3 2025) = <span className="text-white">889x crecimiento en 5 años</span>. Platanus es el primer inversionista institucional de Toku (marzo 2021). Primeras mujeres chilenas en ser apoyadas por Y Combinator (junio 2021). Late Seed liderado por F-Prime Capital (marzo 2022, $7M a $42M valuation). Serie A liderada por Oak HC/FT (abril 2025, $48M a $180M valuation) — la Serie A más grande de LatAm liderada por una mujer. ARR se ha duplicado por tercer año consecutivo (2023–2025). Operando en 3 países: Chile, México y Brasil con 260 personas en el equipo.</Body>
        </CaseSection>
        <CaseSection title="Cómo nos conocimos y por qué invertimos">
          ...
          <Body>Cuando estábamos cerrando el Build Sprint, parecía que no iban a lograrlo. Pero entonces llegó el último reporte: habían cerrado 3 nuevos clientes esa semana. <span className="text-white">Prometieron 8, entregaron 9.</span></Body>
        ...
        <CaseSection title="El equipo">
          ...
          <Body>Lo que vimos en ellos: <span className="text-white">Skin in the game</span> — financiaron sus primeros meses de operación con un pequeño aporte de capital de cada uno (USD 2.5k por founder). <span className="text-white">Build sprint</span> — equipo con gran capacidad de ejecución, disciplina y foco. <span className="text-white">Data-driven deciders</span> — obsesión por los números y la calidad de los entregables.</Body>
        </CaseSection>
        <CaseSection title="Cómo los apoyamos">
        ...
        <CaseSection title="Take-aways del negocio">
          <Body><span className="text-white">De 4 a 450 clientes en 4 años:</span> crecimiento sostenido de 4 clientes corporativos en enero 2021 a 450 clientes en abril 2025.</Body>
          <Body><span className="text-white">Expansión geográfica exitosa:</span> de operar solo en Chile a tener presencia en 3 mercados (México, Brasil y Chile).</Body>
          <Body><span className="text-white">Escalamiento del equipo:</span> de 3 fundadores a 170 personas en 4 años.</Body>
          <Body><span className="text-white">Confianza de inversionistas top-tier:</span> seleccionamos a un equipo que también resultó interesante para inversionistas de primer nivel como Oak HC/FT, F-Prime, Gradient Ventures (Google), Y Combinator y Honey Island by 8UM.</Body>
          <Body><span className="text-white">Capital Efficiency:</span> $16M ARR con $57M levantados = 0.28x Capital/ARR ratio (top decile para B2B SaaS en LatAm).</Body>
        </CaseSection>
        <CaseSection title="Lo que aprendimos">
          <Body><span className="text-white">En pre-semilla todo puede cambiar:</span> el mercado, la solución, el modelo de negocios. La única constante es el equipo. Toku, Fintoc, Grupalia y Bemmbo pivotearon su modelo en algún momento, por lo que tenemos claro que lo que más importa en pre-semilla es invertir en equipos con agencia y ambición.</Body>
          <Body><span className="text-white">La ventaja estructural de Platanus:</span> la mayoría de los VCs en la región invierten en Seed o Series A, cuando las valuaciones ya reflejan tracción validada. El alpha está en el pre-seed, pero necesita capacidad de detección antes de la validación de mercado. Muchas de las mejores oportunidades pasan de una ronda angel a aplicar a fondos tier 1 de Estados Unidos, como Y Combinator, saltándose los fondos locales. La única forma de competirle a YC es entrar antes que YC. Platanus ha construido esa capacidad.</Body>
          <Body><span className="text-white">La comprobación de nuestro modelo:</span> Toku es el fund returner del fondo Génesis de Platanus. En diciembre del 2022 logramos vender secundarias de Toku en su Serie A — esto dejó el DPI en 1.41x. Todavía tenemos ~2% de Toku. MOIC de 76.81x: nuestra inversión de $50K tiene hoy un valor total de $3,840,576 USD.</Body>
...
function CaseBemmbo() {
  return (
    <div className="border border-white/10 bg-white/5 mb-4">
      ...
      <div className="px-6">
        <CaseSection title="Resumen ejecutivo">
          <Body>De $115 MRR (septiembre 2021) a $67,000 MRR (junio 2025) = <span className="text-white">582x crecimiento en ~4 años</span>. Estado al momento del exit: 100+ clientes, NPS de 60, crecimiento lento a moderado. Quintuplicaron ventas en los últimos 2 años. Adquirida por Buk en agosto 2025 para convertirse en su brazo financiero. Retorno en 3.3 años.</Body>
        </CaseSection>
        <CaseSection title="Cómo nos conocimos y por qué invertimos">
