      ...
      <table className="w-full border-collapse table-fixed">
        ...
        <tbody>
          {entries.map((entry, ri) => (
            <tr key={entry.label}>
              <td className={`font-mono font-medium text-xs p-1.5 border border-black/10 ${entry.platanus ? "bg-black/5 text-[#FFEC40]" : "bg-black/5 text-black"}`}>
                {entry.label}
...
export function SectionEstrategia() {
  return (
    <section id="estrategia" className="py-16 border-b border-black/10">
      ...
      <Callout>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          En los mejores fondos casi un <span className="bg-[#474402] text-[#FFEC40] px-1">95% de los retornos</span> se compone de ese <span className="bg-[#474402] text-[#FFEC40] px-1">10% del portafolio</span> que retorna en promedio <span className="bg-[#474402] text-[#FFEC40] px-1">60x</span>. Sin esas startups ganadoras no se llega al 3x tan anhelado.
        </p>
      </Callout>
      ...
      <div className="space-y-4 mb-6">
        ...
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          Ejemplo. Para Platanus Cavendish, con una inversión de $200k, un fund returner debe retornar <span className="bg-[#474402] text-[#FFEC40] px-1  text-black">75x</span> la inversión inicial.
        </p>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
      ...
      <Callout>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          Salvo nuestra valorización estándar de <span className="bg-[#474402] text-[#FFEC40] px-1">$200k por un 7%</span>, ninguna otra inversión logra llegar a un múltiplo de retorno de 60x.
        </p>
      </Callout>
      ...
      <div className="space-y-4 mb-6">
        ...
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          Tomemos como ejemplo <Image src="/avatars/toku.png" alt="Toku" width={20} height={20} className="inline-block align-text-bottom" /> Toku, startup invertida por Platanus el primer semestre del 2021 que a la fecha ya ha levantado su Serie A y B.
        </p>
      </div>
      ...
      <Callout>
        ...
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed mt-3">
          Si suponemos que en 3–4 años levantará una ronda a 2.5x de valorización y consideramos una dilución de 25%, el potencial exit sería de <span className="bg-[#474402] text-[#FFEC40] px-1">$17,226,562 — un fund returner de 86x</span>.
        </p>
      </Callout>
      ...
      <div className="space-y-4 mt-6 mb-10">
        ...
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
          <Image src="/avatars/bemmbo.webp" alt="Bemmbo" width={20} height={20} className="inline-block align-text-bottom" /> Bemmbo, por ejemplo, se vendió el 2025 a Buk por $6 millones.
        </p>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
      ...
      <div className="space-y-20">
        ...
        <div className="flex gap-6">
          <span className="inline-flex items-start justify-center bg-[#474402] text-[#FFEC40] font-mono font-medium text-sm w-8 h-7 shrink-0 mt-0.5">01</span>
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">Ventajas de tener un cofundador técnico:</p>
              <ol className="list-decimal list-outside pl-5 space-y-2">
                {[
        ...
        {/* Mitigación 2 */}
        <div className="flex gap-6">
          <span className="inline-flex items-start justify-center bg-[#474402] text-[#FFEC40] font-mono font-medium text-sm w-8 h-7 shrink-0 mt-0.5">02</span>
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
                Desde el 2020 hemos revisado <span className="bg-[#474402] text-[#FFEC40] px-1">9.549 postulaciones</span>, conducido <span className="bg-[#474402] text-[#FFEC40] px-1">1.697 entrevistas</span> e invertido en <span className="bg-[#474402] text-[#FFEC40] px-1">121 startups</span>. Semestre a semestre hemos ido desarrollando el músculo de ir identificando características que aumentan las posibilidades de que un equipo logre armar una startup exitosa.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Mitigación 3 */}
        <div className="flex gap-6">
          <span className="inline-flex items-start justify-center bg-[#474402] text-[#FFEC40] font-mono font-medium text-sm w-8 h-7 shrink-0 mt-0.5">03</span>
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
                Tenemos más posibilidades de estar en 2 o 3 startups excepcionales entre <span className="bg-[#474402] text-[#FFEC40] px-1">40–45 inversiones</span> que entre 10.
              </p>
              <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">
        ...
        {/* Mitigación 4 */}
        <div className="flex gap-6">
          <span className="inline-flex items-start justify-center bg-[#474402] text-[#FFEC40] font-mono font-medium text-sm w-8 h-7 shrink-0 mt-0.5">04</span>
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="font-sans font-medium text-black/60 text-sm leading-relaxed">Lo principal para dar ese valor agregado es:</p>
              <ul className="list-disc list-outside pl-5 space-y-2">
                {[
