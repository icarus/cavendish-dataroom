...
export function SectionComunidad() {
  ...
  return (
    <section id="comunidad" className="py-16 border-b border-[#E5E7EB]">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5 rounded mb-4">02</span>
      ...
      <blockquote className="border-l-2 border-[#FFEC40] pl-5 mb-10">
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-3 italic">
        ...
        <p className="font-mono font-medium text-[#111111] text-base uppercase tracking-wider">— Paul Graham</p>
      </blockquote>
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-3">Esta comunidad apoya de varias formas:</p>
      ...
      <Callout>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          El valor agregado que aporta una buena comunidad permite invertir a <span className="bg-[#FFEC40] px-1 rounded">menores valorizaciones que el mercado</span>.
        </p>
      </Callout>
      ...
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4">
        A lo largo de estos años hemos invertido en <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">121 startups</span> con más de <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">350 fundadores</span> repartidos en <span className="bg-[#FFEC40] px-1 rounded text-[#111111]">+10 países</span> de América.
      </p>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-10">
      ...
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3">Foco en tech</h4>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-8">
      ...
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3">Programa de aceleración en batches</h4>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4">
      ...
      <Callout>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Cada startup comienza a definirse como <span className="bg-[#FFEC40] px-1 rounded">"soy parte de la generación X de Platanus"</span>, en vez de "me invirtió tal y tal fondo." Esta es una lealtad que no vemos hacia otros fondos.
        </p>
      </Callout>
      ...
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-3 mt-10">Espacios</h4>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-4">
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <figure>
          ...
          <img
            ...
            className="w-full rounded-lg border border-[#E5E7EB] object-cover aspect-[4/3]"
          />
          <figcaption className="font-sans font-medium text-[#6B7280] text-sm leading-relaxed mt-2">
      ...
      <figure className="mb-8 flex flex-col items-center">
        <video
          ...
          controls
          className="w-1/2 rounded-lg border border-[#E5E7EB]"
        />
        <figcaption className="font-sans font-medium text-[#6B7280] text-sm leading-relaxed mt-2">
      ...
      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-4">Eventos</h4>
      <div className="space-y-0 mb-10">
        {events.map((e) => (
          <div key={e.name} className="flex gap-4 py-4 border-b border-[#E5E7EB] last:border-0">
            <span className="font-sans font-medium text-[#111111] text-base w-52 shrink-0">{e.name}</span>
            <span className="font-sans font-medium text-[#111111] text-base leading-relaxed">{e.desc}</span>
          </div>
        ))}
      </div>

      <h4 className="font-mono font-medium text-[#6B7280] text-base uppercase tracking-wider mb-4">Comunidades digitales activas en Slack</h4>
      <p className="font-sans font-medium text-[#111111] text-base leading-relaxed mb-6">
      ...
      <div className="space-y-6 mb-10">
        {slackChannels.map((group) => (
          <div key={group.group}>
            <p className="font-mono font-medium text-[#111111] text-base uppercase tracking-wider mb-3">{group.group}</p>
            <div className="space-y-0">
              {group.channels.map((ch) => (
                <div key={ch.name} className="flex gap-4 py-2.5 border-b border-[#F3F4F6] last:border-0">
                  <span className="font-mono font-medium text-[#111111] text-sm w-36 shrink-0">{ch.name}</span>
                  <span className="font-sans font-medium text-[#111111] text-base leading-relaxed">{ch.desc}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <Callout>
        <p className="font-sans font-medium text-[#111111] text-base leading-relaxed">
          Tres años y medio después, <span className="bg-[#FFEC40] px-1 rounded">Buk adquirió Bemmbo</span>, generando un retorno para Platanus. Un caso perfecto de cómo funciona la comunidad.
        </p>
      </Callout>
    </section>
  );
