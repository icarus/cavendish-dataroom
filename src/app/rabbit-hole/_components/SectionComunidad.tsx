...
export function SectionComunidad() {
  ...
  return (
    <section id="comunidad" className="py-16 border-b border-white/10">
      <span className="inline-block bg-[#FFEC40] text-black font-mono font-medium text-base px-2 py-0.5mb-4">02</span>
      ...
      <blockquote className="border-l-2 border-[#FFEC40] pl-5 mb-10">
        <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-3 italic">
        ...
        <p className="font-mono font-medium text-white text-sm uppercase tracking-wider">— Paul Graham</p>
      </blockquote>
      ...
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-3">Esta comunidad apoya de varias formas:</p>
      ...
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3">Foco en tech</h4>
      ...
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3">Programa de aceleración en batches</h4>
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-4">
      ...
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-3 mt-10">Espacios</h4>
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-4">
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <figure>
          ...
          <img
            ...
            className="w-full border border-white/10 object-cover aspect-[4/3]"
          />
          <figcaption className="font-sans font-medium text-white/40 text-sm leading-relaxed mt-2">
      ...
      <figure className="mb-8 flex flex-col items-center">
        <video
          ...
          controls
          className="w-1/2 border border-white/10"
        />
        <figcaption className="font-sans font-medium text-white/40 text-sm leading-relaxed mt-2">
      ...
      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-4">Eventos</h4>
      <div className="space-y-0 mb-10">
        {events.map((e) => (
          <div key={e.name} className="flex gap-4 py-4 border-b border-white/10 last:border-0">
            <span className="font-sans font-medium text-white/70 text-sm w-52 shrink-0">{e.name}</span>
            <span className="font-sans font-medium text-white/70 text-sm leading-relaxed">{e.desc}</span>
          </div>
        ))}
      </div>

      <h4 className="font-mono font-medium text-white/40 text-sm uppercase tracking-wider mb-4">Comunidades digitales activas en Slack</h4>
      <p className="font-sans font-medium text-white/70 text-sm leading-relaxed mb-6">
      ...
      <div className="space-y-6 mb-10">
        {slackChannels.map((group) => (
          <div key={group.group}>
            <p className="font-mono font-medium text-white text-sm uppercase tracking-wider mb-3">{group.group}</p>
            <div className="space-y-0">
              {group.channels.map((ch) => (
                <div key={ch.name} className="flex gap-4 py-2.5 border-b border-white/10 last:border-0">
                  <span className="font-mono uppercase font-medium text-white/70 text-sm w-36 shrink-0">{ch.name}</span>
                  <span className="font-sans font-medium text-white/70 text-sm leading-relaxed">{ch.desc}</span>
                </div>
              ))}
            </div>
          </div>
