    ...
    <section id="diagnostico" className="py-16 border-b border-black/10">
      ...
      <Callout>
        <p className="font-sans font-medium text-black/60 text-sm leading-relaxed mb-3">
          Invertimos <span className="bg-[#474402] text-[#FFEC40] px-1">US$200,000</span> en las primeras etapas de equipos excepcionales, priorizando los intereses de los fundadores y el éxito de la startup.
        </p>
      ...
      <Callout>
        ...
        <ul className="list-disc list-outside pl-5 space-y-2">
          <li className="font-sans font-medium text-black/60 text-sm leading-relaxed">
            <span className="bg-[#474402] text-[#FFEC40] px-1  text-black">"Quod natura non dat, Platanus non praestat"</span>. Este no es un programa educativo. Lo que busca es que los fundadores se potencien entre ellos y construyan sus negocios recibiendo consejos y accountability.
          </li>
          <li className="font-sans font-medium text-black/60 text-sm leading-relaxed">
      ...
      <p className="font-sans font-medium text-black/60 text-sm leading-relaxed mb-8">
        Hoy contamos con <span className="bg-[#474402] text-[#FFEC40] px-1  text-black">+120 startups</span> en el portafolio, <span className="bg-[#474402] text-[#FFEC40] px-1  text-black">+350 fundadores</span> repartidos en <span className="bg-[#474402] text-[#FFEC40] px-1  text-black">+10 países</span> y una amplia red de mentores.
      </p>
